...
$filePath = $_SERVER['DOCUMENT_ROOT'] . '/xml/' . 'export_novinki.csv'; // Путь до файла, куда записываем данные из инфоблока, от корня сайта
...

{
    ...
    if ($arFields[PROPERTY_NOVINKI_VALUE] == 1) // Проверяем, новинки
    if ($arFields[CATALOG_QUANTITY] >= 1) // Проверяем остаток >0
   {
...
LocalRedirect('/xml/export_novinki.csv')
?>
